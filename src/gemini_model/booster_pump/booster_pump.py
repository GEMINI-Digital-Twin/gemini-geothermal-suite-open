"""Surface booster pump model.

Estimates the pressure change and temperature drop across a surface
booster pump using a linear flow-dependent characteristic curve.
"""

from gemini_model.model_abstract import StaticModel


class BoosterPump(StaticModel):
    """Surface booster pump pressure/temperature model."""
